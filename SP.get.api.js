(function(){ 
  ...
  $('#ranking_influential_table').addEventListener('click', function() {   
    retrieve2('Ranking influential schools or organizations ', '_', 'rank_table', 'query2')
	$('#query2').scrollIntoView() });

  $('#btn_person_life_trajectory').addEventListener('click', function() {
    const personname=$("#personname").value;
    retrieve2('Show Life Trajectory', personname, 'person_life', 'query2')
	$('#query2').scrollIntoView() });


  $('#btn_filterclass').addEventListener('click', function() {
    const classlabel=$("#classlabel").value;
    retrieve2(`Filter out Person in a certain field-${classlabel}`, classlabel, 'filterclass', 'query2')
	$('#query2').scrollIntoView() });
  

  $('#btn_Showcase_celebrity_social_connections').addEventListener('click', function() {
    const personname=$("#personname2").value;
    retrieve2('Showcase celebrity social connections', personname, 'Showcase_celebrity_social_connections', 'query2')
	$('#query2').scrollIntoView() });


  $('#btn_Calculating_Celebrity_Influence').addEventListener('click', function() {
    // const count=$("#topcount").value;
    retrieve2(`Calculating Celebrity Influence`, "_", 'Calculating_Celebrity_Influence', 'query2')
	$('#query2').scrollIntoView() });
  ...
  async function retrieve(parameter1, parameter2, queryID, elementID_query) {
	...
	API_domain = "http://localhost:8080"//'http://localhost:8080'  // for testing on laptop
